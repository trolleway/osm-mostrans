...
<qgis version="2.10.1-Pisa" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{9c3d3d5f-033f-405c-a002-932a610a27bc}">
      <rule filter="fclass = 'trunk'" key="{c36a59a6-df72-4825-ad69-937354094fa9}" symbol="0" label="trunk"/>
      <rule filter="fclass = 'motorway'" key="{08e27b4e-3413-4c8e-88ab-97956354e121}" symbol="1" label="motorway"/>
      <rule scalemaxdenom="1000000" filter="fclass = 'primary'" key="{1f84d110-f5ff-485f-848b-9ff49fa11d81}" symbol="2" scalemindenom="1" label="primary"/>
      <rule scalemaxdenom="1000000" filter="fclass = 'secondary'" key="{5700d979-f759-48a9-8bcd-819962da18e2}" symbol="3" scalemindenom="1" label="secondary"/>
      <rule scalemaxdenom="50000" filter="fclass = 'tertiary'" key="{fe55b910-5947-4b5a-8760-c4baf18ab81f}" symbol="4" scalemindenom="1" label="tertiary"/>
      <rule checkstate="0" filter="fclass = 'residential'" key="{b3c812eb-2bea-4c84-872a-6aa627ff8eb1}" symbol="5" label="residential"/>
      <rule checkstate="0" filter="fclass = 'unclassified'" key="{8aa2f229-f8e7-454b-a9ad-41cf1289fb8b}" symbol="6" label="unclassified"/>
      <rule checkstate="0" filter="fclass = 'pedestrian'" key="{3a4b8cdf-ede7-4dfb-983a-dc643cfb5f9a}" symbol="7" label="pedestrian"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="184,187,187,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="3">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="209,212,212,255"/>
          <prop k="line_style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="5">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="54,152,213,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="6">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="116,209,186,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="7">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="99,231,33,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/textColorB" value="148"/>
    <property key="labeling/textColorG" value="148"/>
    <property key="labeling/textColorR" value="146"/>
